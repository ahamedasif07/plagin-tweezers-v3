...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
	...
	<tr>
		<td style="background:#b71c2b;background:linear-gradient(135deg,#b71c2b 0%,#8f1521 100%);border-radius:12px 12px 0 0;padding:32px 32px 28px;text-align:center;">
			<p style="margin:0 0 6px;font-size:12px;letter-spacing:2px;text-transform:uppercase;color:#f8c9ce;font-weight:600;">New Lead &middot; <?php echo esc_html( $settings['company_name'] ); ?></p>
			<h1 style="margin:0;font-size:24px;line-height:1.3;color:#ffffff;font-weight:700;">New Quote Request</h1>
		</td>
	</tr>
	...
	<tr>
		<td style="background:#ffffff;padding:0 32px;">
			<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:-18px;">
				<tr>
					<td align="center" style="background:#fdf3f4;border:1px solid #e5c3c3;border-radius:999px;padding:10px 20px;">
						<span style="color:#8f1521;font-size:13px;font-weight:700;letter-spacing:0.3px;"><?php echo esc_html( $product_label ); ?> &middot; Qty <?php echo esc_html( number_format_i18n( $submission['quantity'] ) ); ?></span>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td style="background:#ffffff;padding:28px 32px 8px;">
			<p style="margin:0;font-size:15px;line-height:1.6;color:#374151;">
				A new sample / quote request came in from <strong><?php echo esc_html( $submission['name'] ); ?></strong> on
				...
				<tr>
					<td style="padding:22px 24px 8px;">
						<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td style="font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#b71c2b;font-weight:700;">Order Details</td>
			...
			<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:10px;">
				<tr>
					<td style="padding:18px 22px;">
						<p style="margin:0 0 12px;font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#9ca3af;font-weight:700;">Uploaded Logo</p>
						<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;">
							<tr>
								<td align="center" style="padding:16px;">
									<img src="<?php echo esc_url( $submission['logo_url'] ); ?>" width="200" alt="Customer logo" style="display:block;width:200px;max-width:100%;height:auto;object-fit:contain;border-radius:6px;" />
								</td>
							</tr>
						</table>
					</td>
					...
					<td style="padding:18px 22px;">
						...
						<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;color:#374151;line-height:1.9;">
							...
							<tr>
								...
								<td style="font-weight:600;color:#111827;"><a href="mailto:<?php echo esc_attr( $submission['email'] ); ?>" style="color:#b71c2b;text-decoration:none;font-weight:600;"><?php echo esc_html( $submission['email'] ); ?></a></td>
							</tr>
			...
			<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid #e5e7eb;padding-top:18px;">
				<tr>
					<td style="text-align:center;">
						...
						<p style="margin:0;font-size:11px;color:#9ca3af;">Reply directly to this email to reach the customer.</p>
					</td>
				</tr>
			</table>
		</td>
