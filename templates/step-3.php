...
<div class="ttq-step-head">
	...
	<p class="ttq-sub">
		<?php esc_html_e('Please provide your contact information and shipping address so we can prepare your sample request or personalized quote.', 'ttq'); ?>
	</p>
</div>
...
<div class="ttq-contact-card">
	...
	<div class="ttq-contact-card__section">
		...
		<div class="ttq-field-group">
			...
			<input type="text" id="ttq-org" name="organization"
				placeholder="<?php esc_attr_e('Enter organization name', 'ttq'); ?>" />
		</div>

		<div class="ttq-field-group--split">
			<div>
				<label class="ttq-field-label" for="ttq-name"><?php esc_html_e('Your Name', 'ttq'); ?> <span
						class="req">*</span></label>
				<!-- <p class="ttq-field-hint-text"><?php esc_html_e('First and last name', 'ttq'); ?></p> -->
				<input type="text" id="ttq-name" name="name"
					placeholder="<?php esc_attr_e('First and last name', 'ttq'); ?>" required />
				<div class="ttq-field-error" data-error-for="name" role="alert"></div>
			</div>
			<div>
				<label class="ttq-field-label" for="ttq-phone"><?php esc_html_e('Phone Number', 'ttq'); ?> <span
						class="req">*</span></label>
				<input type="tel" id="ttq-phone" name="phone"
					placeholder="<?php esc_attr_e('Enter phone number', 'ttq'); ?>" required />
	...
	<div class="ttq-contact-card__section">
		...
		<div class="ttq-field-group">
			<label class="ttq-field-label" for="ttq-email"><?php esc_html_e('Email Address', 'ttq'); ?> <span
					class="req">*</span></label>
			<input type="email" id="ttq-email" name="email"
				placeholder="<?php esc_attr_e('Enter email address', 'ttq'); ?>" required />
	...
	<div class="ttq-contact-card__section ttq-js-address-section">
		...
		<div class="ttq-field-group">
			<p class="ttq-field-hint-text">
				<?php esc_html_e('Please enter your complete shipping address, including city, state, and ZIP code.', 'ttq'); ?>
			</p>
			<textarea id="ttq-address" name="address" rows="3"
				placeholder="<?php esc_attr_e('Enter complete shipping address', 'ttq'); ?>"></textarea>
			...
			<div class="ttq-callout ttq-callout--warning">
				...
				<!-- alert box -->
				<div class="ttq-alert">
					<div class="ttq-alert__icon">!</div>
					<div class="ttq-alert__content">
						<strong><?php esc_html_e('Please Note: PO Boxes are not accepted.', 'ttq'); ?></strong>
						<p><?php esc_html_e('A physical shipping address is required for delivery so we can process and ship your sample request.', 'ttq'); ?>
						</p>
					</div>
					<div class="ttq-alert__visual">
						<svg width="55" height="55" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M10 20L30 10L50 20V40L30 50L10 40V20Z" stroke="#1f2937" stroke-width="3"
								stroke-linecap="round" stroke-linejoin="round" />
							<path d="M10 20L30 30L50 20" stroke="#1f2937" stroke-width="3" stroke-linecap="round"
								stroke-linejoin="round" />
							<path d="M30 30V50" stroke="#1f2937" stroke-width="3" stroke-linecap="round"
								stroke-linejoin="round" />
							<circle cx="30" cy="30" r="26" stroke="#dc2626" stroke-width="4" />
							<line x1="12" y1="12" x2="48" y2="48" stroke="#dc2626" stroke-width="4"
...
<div class="ttq-nav-row">
	...
	<button type="button" class="ttq-btn ttq-btn--primary ttq-js-next"><?php esc_html_e('Continue to Review', 'ttq'); ?>
